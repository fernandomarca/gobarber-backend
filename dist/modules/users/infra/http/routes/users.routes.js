...
var _ensuraAuthenticated = _interopRequireDefault(require("../middlewares/ensuraAuthenticated"));
...
usersRouter.patch('/avatar', _ensuraAuthenticated.default, upload.single('avatar'), usersAvatarController.update);
