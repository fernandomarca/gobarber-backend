...
let UpdateProfileService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IUserRepositories.default === "undefined" ? Object : _IUserRepositories.default, typeof _IHashProvider.default === "undefined" ? Object : _IHashProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class UpdateProfileService {
  ...
  async execute({
    ...
    if (userWithUpdatedEmail && userWithUpdatedEmail.id !== user_id) {
      throw new _AppError.default('user email already in use');
    }
