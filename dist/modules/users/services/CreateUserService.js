...
let CreateUserService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _IUserRepositories.default === "undefined" ? Object : _IUserRepositories.default, typeof _IHashProvider.default === "undefined" ? Object : _IHashProvider.default, typeof _ICachaProvider.default === "undefined" ? Object : _ICachaProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = class CreateUserService {
  ...
  async execute({
    ...
    if (checkUserExists) {
      throw new _AppError.default('Email addres is already used');
    }
